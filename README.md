...
- Day3.py - Lists & Tuples (append, sort, slice, insert, remove, copy, index, count)
- Day4.py - Dictionary and sets (nesting, keys/values/items, update , unique elements, add/remove/pop, union, intersection).
